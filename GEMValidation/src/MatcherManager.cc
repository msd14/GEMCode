...
MatcherManager::MatcherManager(const edm::ParameterSet& iPS, edm::ConsumesCollector&& iC) {
  ...
  // me0_digis_.reset(new L1TrackMatcher(iPS, std::move(iC)));
  // me0_rechits_.reset(new L1TrackMatcher(iPS, std::move(iC)));
